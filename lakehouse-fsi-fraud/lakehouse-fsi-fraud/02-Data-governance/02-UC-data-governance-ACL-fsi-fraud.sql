...
GRANT SELECT ON TABLE tddbricks_sea.dbdemos_fsi_fraud_detection.gold_transactions TO `analysts`;
GRANT SELECT ON TABLE tddbricks_sea.dbdemos_fsi_fraud_detection.gold_transactions TO `analysts`;
GRANT SELECT ON TABLE tddbricks_sea.dbdemos_fsi_fraud_detection.gold_transactions TO `analysts`;

-- We'll grant an extra MODIFY to our Data Engineer
GRANT SELECT, MODIFY ON SCHEMA tddbricks_sea.dbdemos_fsi_fraud_detection TO `dataengineers`;
